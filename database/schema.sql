...
CREATE TABLE IF NOT EXISTS reports (
    ...
    -- Nullable because some historical reports were created
    -- by temporary Socket.IO connection IDs that no longer
    -- exist in the persistent user registry.
    reporter_uuid TEXT REFERENCES users(uuid),

    -- Preserve the original reporter identifier for audit/history.
    reporter_legacy_id TEXT,
